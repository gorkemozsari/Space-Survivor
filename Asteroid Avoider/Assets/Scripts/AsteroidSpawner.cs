...
public class AsteroidSpawner : MonoBehaviour
{
    ...
    [SerializeField] private float secondsBetweenAsteroidsMultiplier = 0.01f;
    ...
    void Update()
    {
        ...
        secondsBetweenAsteroids -= Time.deltaTime * secondsBetweenAsteroidsMultiplier;
        if(secondsBetweenAsteroids < 0.1) {secondsBetweenAsteroids = 0.1f;}
